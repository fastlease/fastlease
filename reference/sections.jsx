		...
		<header className={`nav ${scrolled ? "scrolled" : ""}`}>
			<div className="wrap nav-inner">
				...
				<nav className="nav-links">
					...
					<a className="nav-link" href="#leases">
						Recent Leases
					</a>
				</nav>
			...
			<div className="wrap hero-inner">
				...
				<Reveal as="h1" className="hero-h">
					{data.h.split("\n").map((line, i, arr) => (
						<span key={i}>
							{i === arr.length - 1 ? (
								<span className="accent-period">{line}</span>
							) : (
								line
							)}
							{i < arr.length - 1 && <br />}
				...
				<Reveal as="p" className="hero-sub">
					A modern leasing system for Toronto condo owners. If we don't sign a
					qualified tenant in {GUARANTEE_DAYS} days, you don't pay until we do.
				</Reveal>
				<Reveal as="div" className="hero-ctas">
					...
					<a className="ulink hero-secondary" href="#how">
			...
			<div className="wrap">
				...
				<div className="timeline-head">
					...
					<Reveal as="p" className="timeline-lede">
						Most leasing services sell their best effort. We sell a date. Here's
						what the twenty-one days actually look like — and where the unit
						below this paragraph sits today.
					</Reveal>
				</div>
...
function TimelineMobile() {
	const items = [
		...
		{
			phase: 2,
			phaseName: "Qualified showings",
			day: 5,
			label: "First showings",
			start: true,
		},
		{
			phase: 2,
		...
		},
		{
			...
			phaseName: "Qualified showings",
			day: 13,
			label: "Sample unit — today",
			today: true,
		},
		{
			phase: 3,
			phaseName: "Screened and signed",
			day: 16,
	...
	return (
		<ol className="tl-mobile">
			{items.map((it, i) => (
				<li
					className={`tl-mobile-item ${it.today ? "is-today" : ""} ${it.start ? "phase-start" : ""}`}
					key={i}
				>
					{it.start && (
						<div className="tl-mobile-phase">
							Phase 0{it.phase} · {it.phaseName}
						</div>
					)}
					<div className="tl-mobile-day">
			...
			<div className="wrap problem-grid">
				...
				<div className="problem-body">
					...
					<div className="problem-cols">
						<Reveal as="p">
							The number above is the daily rent on a typical King West
							one-bedroom. Vacancy is rarely dramatic. It's a slow leak — three
							weeks here, six there — that most landlords don't sit down and
							total at the end of the year.
						</Reveal>
						<Reveal as="p">
							That's why FastLease is built around a date instead of a best
							effort. We don't think you're losing thousands. We think you
							already know the math, and you'd rather work with someone who
							reports against it.
						</Reveal>
					</div>
				</div>
		...
		<section className="section how-sec" id="how">
			<div className="wrap">
				...
				<Reveal as="p" className="how-lede">
					...
					promise. The gap between the two is deliberate — and the reason
					landlords stop reading other leasing sites once they reach this
					section.
				</Reveal>

				<div className="how-grid">
					{PHASE_CARDS.map((p, i) => (
						<Reveal as="div" className="how-card card" key={i}>
							...
							<ul className="how-card-list">
								{p.bullets.map((b, j) => (
									<li key={j}>
										<span className="how-card-tick">›</span> {b}
									</li>
								))}
							</ul>
						</Reveal>
		...
		<section className="section screen-sec">
			<div className="wrap">
				...
				<div className="screen-list card">
					{SCREENING.map((s, i) => (
						<Reveal as="div" className="screen-row" key={i}>
				...
				<Reveal as="p" className="screen-foot">
					We move quickly. We don't cut corners. The two are easier to reconcile
					than most landlords have been led to believe.
				</Reveal>
			</div>
		</section>
	);
...
function RecentLeases({ layout }) {
	return (
		<section className="section leases-sec" id="leases">
			<div className="wrap">
				<Reveal as="div" className="kicker">
								...
								<div className="lease-card card" key={i}>
									...
									<div className="lease-card-meta">
										...
										<div className="lease-card-row">
											...
											<span className={`num ${delta >= 0 ? "acc" : ""}`}>
								...
								{LEASES.map((l, i) => {
									...
									return (
										<tr key={i}>
											...
											<td className={`num-cell ${delta >= 0 ? "acc" : ""}`}>
												{delta >= 0 ? "+" : "−"}${Math.abs(delta)}
											</td>
				...
				<Reveal as="div" className="leases-foot">
					<span className="leases-foot-num">
						<CountUp decimals={1} suffix="%" to={99.4} />{" "}
					</span>
					<span className="leases-foot-label">
						of asking rent achieved across closed 2025 leases.
					</span>
				</Reveal>
			</div>
		</section>
	...
	return (
		<section className="section pricing-sec" id="pricing">
			<div className="wrap">
				...
				<Reveal as="h2" className="pricing-h">
				...
				<div className="pricing-grid">
					<Reveal as="div" className="pricing-card card">
						...
						<ul className="pricing-list">
							<li>
								<span className="t">›</span> Pricing analysis & professional
								photography
							</li>
							<li>
								<span className="t">›</span> Listed across all major platforms
								(14)
							</li>
							<li>
								<span className="t">›</span> All showings, screening, and
								verification
							</li>
							<li>
								<span className="t">›</span> Lease drafting and execution
							</li>
							<li>
								<span className="t">›</span> Weekly written reports throughout
							</li>
						</ul>
					</Reveal>
					...
					<Reveal as="div" className="pricing-card pricing-guarantee card">
						<div
							className="pricing-card-eyebrow label"
							style={{ color: "var(--accent)" }}
						>
							The 21-day guarantee
						</div>
						<div className="pricing-card-price">
							<span className="pricing-card-amt num">
								Day 22 → you don't pay.
							</span>
						</div>
						<div className="pricing-card-sub">
							In plain English, in three bullets, on the homepage.
						</div>
						<ol className="pricing-list pricing-list-num">
							<li>
								<span className="t num">01</span> If no qualified tenant has
								signed by end of day 21, the fee is suspended. We continue to
								work without invoicing.
							</li>
							<li>
								<span className="t num">02</span> If we lease the unit
								afterward, the original flat fee applies — never any escalation.
							</li>
							<li>
								<span className="t num">03</span> Exclusions are listed once,
								plainly: owners requesting list pricing &gt;5% above our
								recommended range, or units with active building disputes.
							</li>
						</ol>
					</Reveal>
				</div>
				...
				<Reveal as="div" className="pricing-cta">
					...
					<span className="pricing-cta-aside">
	...
	return (
		<section className="section faq-sec">
			<div className="wrap">
				...
				<Reveal as="h2" className="faq-h">
					Eight questions every landlord actually asks.
				</Reveal>
					...
					{FAQS.map((f, i) => (
						...
						>
							...
							>
								...
								<span aria-hidden="true" className="faq-q-icon">
									{open === i ? "−" : "+"}
								</span>
							</button>
	...
	return (
		<section className="section final-sec">
			<div className="wrap final-inner">
				...
				<Reveal as="h2" className="final-h">
				...
				<Reveal as="p" className="final-sub">
					...
					range, and a recommended listing date. No call required unless you ask
					for one.
				</Reveal>
			...
			<div className="wrap footer-inner">
				<div className="footer-brand">
					...
					<p className="footer-line">
						A 21-day leasing system for Toronto condo owners.
					</p>
				</div>
				<div className="footer-cols">
					<div>
						...
						<a className="footer-link" href="#leases">
							Recent Leases
						</a>
					</div>
					<div>
