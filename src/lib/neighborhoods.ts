...
const BLURBS: Record<string, string> = {
	"King West": "Toronto&apos;s highest-velocity 1BR market. Walking renters, fast list-to-lease cycles.",
	"Liberty Village": "Young-professional density and amenity-heavy buildings. Strong 2BR demand.",
	...
	"The Annex": "Family + grad-student split. Pricing precision matters more than speed.",
	...
	"Other Toronto": "Outside the core map. We&apos;ll price against the closest comparable cluster.",
};

export const NEIGHBORHOOD_META: NeighborhoodMeta[] = NEIGHBORHOODS.map((name) => {
